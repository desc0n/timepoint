...
function showBookingPeriod(id, status) {var colors = {'success' : '#82c44f' , 'canceled' : '#bfe1b2', 'active' : '#ecd20a'};var $elems = $('.booking-ceil-period-' + id);var background = rgbToHex($elems.css('background-color'));if(background === '#00d7ec') {$elems.css('background-color', colors[status]);} else {$elems.css('background-color', '#00d7ec');}}
