(function () {
        ...
        var b = {
                ...
                domReady: function () {
                    ...
                    return function (b) {
                        ...
                        if (1 == h.length) if (document.addEventListener) document.addEventListener("DOMContentLoaded", a, !1), window.addEventListener("load", a, !1);
        ...
        CKEDITOR.tools = {
            ...
            extend: function (a) {
                ...
                for (var f = 1; f < b; f++) {
                    var j = arguments[f],
                        i;
                    for (i in j) if (d === true || a[i] == void 0) if (!c || i in c) a[i] = j[i]
                }
                return a
            },
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            removeStyle: function (a) {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], f = 0; f < c.length; f++) if (h) for (var j = 0; j < h.length; j++) b.push([a, c[f], h[j]].join("-"));
    ...
    (function () {
        function b(a, b) {
            ...
            if (this.current) d = this.current[h](false, p, k);
                ...
                if (a) d.type == CKEDITOR.NODE_ELEMENT && (d = e > 0 ? d.getChild(e - 1) : k(d, true) === false ? null : d.getPreviousSourceNode(true, p, k));
                else {
                    d = n;
    ...
    (function () {
        ...
        function c(a) {
            ...
            return function (k) {
                return c(k) || b(k) ? true : !a && f(k) || k.type == CKEDITOR.NODE_ELEMENT && k.is(CKEDITOR.dtd.$removeEmpty)
            }
        }
        function a(a) {
            return !j(a) && !i(a)
            ...
            enlarge: function (a, b) {
                switch (a) {
                            ...
                            for (; m;) {
                                ...
                                if (m.type == CKEDITOR.NODE_COMMENT) m = m.getPrevious();
                                    ...
                                    if (m.type == CKEDITOR.NODE_TEXT) {
                                        ...
                                        x = m.getText();
                                        if (/[^\s\ufeff]/.test(x)) m = null;
                                        else for (var l = m.$.getElementsByTagName("*"), s = 0, C; C = l[s++];) if (!CKEDITOR.dtd.$removeEmpty[C.nodeName.toLowerCase()]) {
                                            m = null;
                                            break
                                        }
                                        m && (r = !! x.length)
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        f = f.lastForward();
                        y = y || g;
                        this.setEndAt(y, !f && this.checkEndOfBlock() || f && y.contains(f) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START);
            ...
            shrink: function (a, b, c) {
                if (!this.collapsed) {
                    var a = a || CKEDITOR.SHRINK_TEXT,
                        ...
                        m = 1,
                        i = 1;
                    if (g && g.type == CKEDITOR.NODE_TEXT) if (e) if (e >= g.getLength()) d.setStartAfter(g);
                    else {
                        d.setStartBefore(g);
                        m = 0
    ...
    (function () {
        ...
        b.prototype = {
            getNextParagraph: function (b) {
                ...
                if (!this._.nextNode) this._.nextNode = l || d.equals(n) || !n ? null : c(d, 1, n);
                return d
            }
        };
    ...
    (function () {
        ...
        function g(a, b, c) {
            var g = a.name;
            if (A.$empty[g] || !a.children.length) if (g == "hr" && b == "br") a.replaceWith(q());
            else {
                a.parent && c.push({
                    check: "it",
                    el: a.parent
                ...
                if (d) {
                    ...
                    for (var f = d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || d.name == "body", p, e = g.length; e > 0;) {
                        ...
                        if (f && (h.type == CKEDITOR.NODE_TEXT || h.type == CKEDITOR.NODE_ELEMENT && A.$inline[h.name])) {
                            ...
                            p = null;
                            h.insertAfter(a);
                            d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (h.type == CKEDITOR.NODE_ELEMENT && !A[d.name][h.name]) && c.push({
                                check: "el-up",
                                el: h
                            })
                        }
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, g) {
                ...
                for (p = g.length; e < p; ++e) {
                    ...
                    if (k.elements === true || k.elements === null) {
                        ...
                        t = k.elements;
                        delete k.elements;
                        for (d in t) if (h[d]) h[d][m ? "unshift" : "push"](k);
                        else h[d] = [k]
                    }
                }
                c.elements = h;
            ...
            applyTo: function (a, b, c) {
                ...
                d.length && (m = true);
                for (var o, t, a = [], c = ["p", "br", "div"][this.enterMode - 1]; o = d.pop();) o.type == CKEDITOR.NODE_ELEMENT ? g(o, c, a) : o.remove();
                for (; t = a.pop();) {
                    o = t.el;
                ...
                if (b(g)) p.push(g);
                    ...
                    if (d == "br") v.push(g);
                        ...
                        for (;;) {
                            ...
                            if (!g.isUnknown && !u.isUnknown && !h[d]) if (u.isOptionalClose) k.onTagClose(f);
                ...
                return function (d) {
                    if (d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (k) for (o(k, 1) && f.push(k); k;) {
                            if (h(k) && (p = e(k)) && o(p)) if ((t = e(p)) && !h(t)) f.push(p);
                            else {
                                var q = p,
                                    j = g(m),
                                    w = q.parent.children,
                        ...
                        if (f = CKEDITOR.env.opera && !b || (typeof c == "function" ? c(d) !== false : c)) if (!m && CKEDITOR.env.ie && d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) f = false;
    ...
    (function () {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElement: function (b) {
                    h(this);
                    for (var c = this.editor, d = c.config.enterMode, g = c.getSelection(), e = g.getRanges(), i = b.getName(), j = CKEDITOR.dtd.$block[i], m, n, l, r = e.length - 1; r >= 0; r--) {
                        m = e[r];
                        if (!m.checkReadOnly()) {
                            m.deleteContents(1);
                            n = !r && b || b.clone(1);
                            var x, z;
                            if (j) for (;
                                (x = m.getCommonAncestor(0, 1)) && (z = CKEDITOR.dtd[x.getName()]) && (!z || !z[i]);) if (x.getName() in CKEDITOR.dtd.span) m.splitElement(x);
                    ...
                    if (l) {
                        ...
                        if (j) if ((b = l.getNext(a)) && b.type == CKEDITOR.NODE_ELEMENT && b.is(CKEDITOR.dtd.$block)) b.getDtd()["#"] ? m.moveToElementEditStart(b) : m.moveToElementEditEnd(l);
        ...
        var n = function () {
            ...
            return function (m, l, z) {
                ...
                if (!C.checkReadOnly()) {
                    var t = (new CKEDITOR.dom.elementPath(C.startContainer, C.root)).blockLimit || C.root,
                        l = {
                            type: l,
                            dontFilter: y,
                            editable: m,
    ...
    (function () {
                        ...
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) k.on("mousedown", function (a) {
                            function b(a) {
                                ...
                                if (e) {
                                    ...
                                    e.setEndPoint(h.compareEndPoints("StartToStart", c) < 0 ? "EndToEnd" : "StartToStart", c);
                                    e.select()
                                }
                            }
                            function c() {
        ...
        CKEDITOR.dom.selection = function (a) {
            ...
            if (CKEDITOR.env.webkit)(b.type == "None" && this.document.getActive().equals(a) || b.type == "Caret" && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && j(a, b);
                ...
                if (o) b.type == "None" && (c && c.equals(this.document.getDocumentElement())) && j(a, null, true);
                else {
                ...
                if (a.length) if (this.isLocked) {
                    ...
                    if (o) {
                        ...
                        if (n && n.type == CKEDITOR.NODE_ELEMENT && n.getName() in q && (!n.is("a") || !n.getText())) try {
                            ...
                            l.select();
                            return
                        } catch (x) {}(b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.getName() in f || b.endContainer.type == CKEDITOR.NODE_ELEMENT && b.endContainer.getName() in f) && b.shrink(CKEDITOR.NODE_ELEMENT, true);
                        l = b.createBookmark();
                        var f = l.startNode,
                            z;
                        if (!a) z = l.endNode;
                        ...
                        if (z) {
                            ...
                            i = !(i && i.getText && i.getText().match(d)) && (j || !f.hasPrevious() || f.getPrevious().is && f.getPrevious().is("br"));
                        ...
                        if (!s || i[s] && !u && (!m || h) && (n.getPosition(k) | CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(n))) {
                            ...
                            if (v && ((v.getDtd() || CKEDITOR.dtd.span)[d] || f) && (!e.parentRule || e.parentRule(v))) {
                                ...
                                if (r == CKEDITOR.NODE_TEXT || m || r == CKEDITOR.NODE_ELEMENT && !n.getChildCount()) {
                                    for (var r = n, x;
                                         (g = !r.getNext(C)) && (x = r.getParent(), i[x.getName()]) && (x.getPosition(l) | CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_FOLLOWING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(x));) r = x;
                                    o.setEndAfter(r)
                                }
                            } else g = true
                        } else g = true;
                    ...
                    getNextRange: function (f) {
                        ...
                        if (j && a.length > 1) {
                            ...
                            if (f) for (var l = 0; a[h + l + 1];) {
                                for (var n = j.document, f = 0, i = n.getById(c[l].endNode), n = n.getById(c[l + 1].startNode);;) {
